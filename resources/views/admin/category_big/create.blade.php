                    ...
                    <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
                        ...
                        <section class="h-full overflow-auto p-8 w-full flex gap-2">
                            <header class="w-2/3 border-dashed border-2 border-gray-400 py-12 px-4 flex flex-col justify-center items-center">
                                ...
                                <input id="create-hidden-input" type="file" multiple class="hidden" accept="image/png, image/jpg, image/jpeg, image/webp" data-file="1" data-min-file="1"/>
                                <button id="create-button" class="mt-2 rounded-sm px-3 py-1 bg-gray-200 hover:bg-gray-300 focus:shadow-outline focus:outline-none">
                                    Tải ảnh
                                </button>
                            </header>

                            <div class="flex-1">
                                <ul id="gallery-create" class="flex flex-1 flex-wrap -m-1">
                    ...
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                        ...
                        <div class="md:col-span-5">
                            ...
                            <div class="relative group mt-1 select-group">
                                <button id="dropdown-menu-create-button" class="relative h-10 bg-gray-50 flex border border-gray-200 rounded items-center px-4 appearance-none outline-none text-gray-800 w-full">
                                ...
                                <div id="dropdown-menu-create" class="hidden absolute right-0 mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 p-1 space-y-1">
                                    <!-- Search input -->
                                    <input id="search-input-create" class="block w-full px-4 py-2 text-gray-800 border rounded-md  border-gray-300 focus:outline-none" type="text" placeholder="Search items" autocomplete="off">
                                </div>
                            </div>
                        </div>
