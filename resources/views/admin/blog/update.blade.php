...
<div id="modal-update-blog-admin" class="fixed inset-0 hidden items-center justify-center">
    <div class="absolute inset-0 bg-black opacity-50"></div>
    <div role="status" class="absolute inset-0 bg-[rgba(0,0,0,0.5)] z-20 items-center justify-center hidden" id="modal-update-blog-admin-loading">
                    ...
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                        <div class="md:col-span-3 grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="title" id="blog-title-update" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" data-empty="1" data-max-length="255" />
                            </div>
                            ...
                            <div class="md:col-span-5">
                                ...
                                <textarea name="description" id="blog-description-update" class="border mt-1 rounded px-4 w-full bg-gray-50" cols="20" rows="5"></textarea>
                            </div>
                        </div>

                        <div class="md:col-span-2">
                            <label for="image-blog-update" class="relative">
                                <img src="" alt="" id="image-blog-thumb-update" onerror="imageDefaultOnLoadError($(this))">
                                <input id="image-blog-update" type="file" class="hidden">
                            </label>
                        </div>
                        ...
                        <div class="md:col-span-5">
                            ...
                            <textarea name="content" id="blog-content-update" cols="30" rows="10"></textarea>
                        </div>

                        <div class="md:col-span-5 text-right">
                            <div class="inline-flex items-end gap-2">
                                <button class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded" onclick="closeModalUpdateBlogAdmin()">Thoát</button>
                                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onclick="saveModalUpdateBlogAdmin()">Lưu lại</button>
                            </div>
                        </div>
...
<script>
    $(function() {
        CKEDITOR.replace("blog-content-update", {
...
<script type="text/javascript" src="{{ asset('js/admin/blog/update.js?version=2')}}"></script>
@endpush