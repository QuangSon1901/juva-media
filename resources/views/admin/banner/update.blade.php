<div id="modal-update-banner-admin" class="fixed inset-0 hidden items-center justify-center">
    <div class="absolute inset-0 bg-black opacity-50"></div>
    <div role="status" class="absolute inset-0 bg-[rgba(0,0,0,0.5)] z-20 flex items-center justify-center hidden" id="modal-update-banner-loading">
                ...
                <div class="text-gray-600 lg:col-span-2">
                    <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md">
                        <section class="h-full overflow-auto p-8 w-full flex gap-2">
                            ...
                            <div class="flex-1">
                                <ul id="gallery-update-banner" class="flex flex-1 flex-wrap -m-1">
                                    <li id="empty-update-banner" class="h-full w-full text-center flex flex-col items-center justify-center">
                ...
                <div>
                    ...
                    <div class="md:col-span-5 text-right pt-3">
                        <div class="inline-flex items-end gap-2">
                            <button class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded" onclick="closeModalUpdateBannerAdmin()">Thoát</button>
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onclick="saveModalUpdateBannerAdmin()">Lưu lại</button>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script type="text/javascript" src="{{ asset('js/admin/banner/update.js?version=2')}}"></script>
@endpush