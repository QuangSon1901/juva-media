...
<div>
    <div class="container mx-auto grid lg:grid-cols-[1fr,3fr] py-6">
        ...
        <div>
            ...
            <div>
                <ul class="grid lg:grid-cols-4 gap-4 py-6" id="products">
                    @foreach ($products as $product)
                        <li>
                            <a href="/san-pham/{{$product['slug']}}" class="block text-center space-y-2 p-4 border border-transparent hover:border-black rounded-2xl border-dashed">
                                <div>
                                    <img class="w-full aspect-[1] object-contain" src="{{$product['image'][0]}}" alt="">
                                </div>  
