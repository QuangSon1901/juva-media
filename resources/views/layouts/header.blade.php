    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div>
            <div class="h-9 px-4 pl-9 relative w-[420px] flex overflow-hidden bg-white border rounded-full border-neutral-400">
                <input type="text" placeholder="Tìm kiếm" class="outline-none border-none bg-transparent w-full">
    ...
    <div class="relative header-bottom-menu">
        <div class="container mx-auto">
            <div class="w-full pb-2">
                <ul class="flex items-center justify-center gap-4" id="header-service-list"></ul>
            </div>
        </div>
