                ...
                <div class="grid grid-cols-2 gap-5 p-4">
                    ...
                    <div class="hidden flex-col gap-6 [&.active]:flex active" id="login-form-modal">
                        <label for="" class="flex flex-col">
                            ...
                            <input type="email" id="email-field-login" class="w-full h-9 p-2 rounded-md border outline-none">
                        </label>
                        <label for="" class="flex flex-col">
                            <span class="font-semibold mb-1">Mật khẩu</span>
                            <input type="password" id="password-field-login" class="w-full h-9 p-2 rounded-md border outline-none">
                        </label>
                        <button class="w-full rounded-full bg-amber-400 border-none font-bold text-center py-3" onclick="loginSubmit()">Đăng nhập</button>
